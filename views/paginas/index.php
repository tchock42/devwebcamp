<?php 
include_once __DIR__ . '/conferencias.php'; //hace referencia al archivo de conferencias
?>
        ...
        <?php foreach($ponentes as $ponente){ ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>   
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="/img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen del ponente">
                </picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <ul class="speaker__listado-skills">
                        <?php $tags = explode(',',  $ponente->tags); //almacena en tags las etiquetas separadas
                            foreach($tags as $tag){ //por cada elemento en tags
                        ?>
                            <li class="speaker__skill"><?php echo $tag; ?></li> <!--imprime tag-->
                        <?php } ?>
                    </ul>
                </div>
            </div>
...
<div id="mapa" class="mapa"></div> <!--Aqui va el mapa-->
