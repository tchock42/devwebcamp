<header class="header"> <!--Contiene la imagen-->
    <div class="header__contenedor"> <!--los elementos del header-->
        <nav class="header__navegacion"> <!--Contiene la imagen-->
            <?php if(is_auth()){ ?> <!--Si esta autenticado-->
                <!--si es administrador manda a dashboard, si no, a finalizar-registro-->
        ...
        <div class="header__contenido"> <!--Contiene el titulo e  informacion del header-->     
            <a href="/">
