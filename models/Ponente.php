...
//clase de creacion y administracion de ponentess
class Ponente extends ActiveRecord{
    protected static $tabla = 'ponentes'; //tabla consultada en la db
    ...
    //validacion del formulario de creacion de ponente
